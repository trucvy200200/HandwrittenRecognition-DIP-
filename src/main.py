...
class FilePaths:
    ...
    fn_char_list = '../model/line/charList.txt'
    fn_summary = '../model/line/summary.json'
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--img_file', help='Image used for inference.', type=Path, default='../data/cropImage-1.png')
